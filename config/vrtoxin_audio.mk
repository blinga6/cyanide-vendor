...
ALARM_PATH := vendor/vrtoxin/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/vrtoxin/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/vrtoxin/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/vrtoxin/prebuilt/common/media/audio/ui
